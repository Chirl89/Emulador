...
[![Version](https://img.shields.io/badge/version-v0.9.1-00f0ff.svg)](./VERSION)
...
3. **💾 Arquitectura de Guardado con Prioridad 1 y Resolución por Timestamp**: Carga local con Prioridad 1, pero si la marca de tiempo de la nube es más reciente, carga la nube. Todos los saves tienen marca de tiempo obligatoria y cualquier guardado sin marca de tiempo es purgado automáticamente (local y nube).
...
A partir de la versión **`v0.9.1`**, el emulador incorpora una suite integrada de edición de guardados de Pokémon:
