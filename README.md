...
[![Version](https://img.shields.io/badge/version-v0.8.3-00f0ff.svg)](./VERSION)
...
A partir de la versión **`v0.8.0+` (optimizado y blindado en `v0.8.3`)**, el emulador incorpora una suite integrada de edición de guardados de Pokémon:
