...
const CACHE_NAME = 'nds-emulator-v0.9.0';
...
self.addEventListener('install', (e) => {
  console.log('[Service Worker] Instalando v0.9.0...');
  self.skipWaiting();
  e.waitUntil(
...
self.addEventListener('activate', (e) => {
  console.log('[Service Worker] Activando v0.9.0 y purgando cachés obsoletas...');
  e.waitUntil(
