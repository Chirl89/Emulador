...
const CACHE_NAME = 'nds-emulator-v0.7.7';
...
self.addEventListener('install', (e) => {
  console.log('[Service Worker] Instalando v0.7.7...');
  self.skipWaiting();
  e.waitUntil(
...
self.addEventListener('activate', (e) => {
  console.log('[Service Worker] Activando v0.7.7 y purgando cachés obsoletas...');
  e.waitUntil(
